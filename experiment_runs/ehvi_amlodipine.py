...
def bayesian_optimization_loop(
    ...
    for iteration in range(n_iterations):
        ...
        if best_smiles:
            ...
            new_Y = evaluate_amlo_objectives([best_smiles])
...
def random_sampling_loop(query_smiles, known_Y, n_iterations=20):
    ...
    for iteration in range(n_iterations):
        ...
        new_Y = evaluate_amlo_objectives([random_smiles])
        known_Y = np.vstack([known_Y, new_Y])
...
def run_experiment(repeats, n_iterations):
    ...
    for experiment_num in range(1, repeats + 1):
        ...
        training_Y = evaluate_amlo_objectives(training_smiles)
...
if __name__ == "__main__":
    ...
    write_results_to_csv(results, 'ehvi_bo_amlodipine_results.csv')
