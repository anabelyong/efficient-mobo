...
def bayesian_optimization_loop(
    ...
    for iteration in range(n_iterations):
        ...
        if best_smiles:
            ...
            new_Y = evaluate_amlo_MPO([best_smiles])
...
def random_sampling_loop(
    ...
    for iteration in range(n_iterations):
        ...
        new_Y = evaluate_amlo_MPO([random_smiles])
...
def write_to_csv(results_bo, results_rs, filename):
    with open(filename, mode="w", newline="") as file:
        ...
        writer.writerow(["Experiment", "Iteration", "Chosen Smiles for Amlo-MPO", "RS-MPO"])
...
def run_experiment(repeats, n_iterations):
    ...
    for experiment_num in range(1, repeats + 1):
        ...
        training_Y = evaluate_amlo_MPO(training_smiles)
...
if __name__ == "__main__":
    ...
    write_to_csv(results_bo, results_rs, "ei_bo_rs_experiments_amlodipine_results.csv")
