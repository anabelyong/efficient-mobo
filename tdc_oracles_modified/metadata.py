...
guacamol_oracle = [
    ...
    "isomers_c11h24",
    "osimertinib_mpo", #change here for separating osimertinib MPO
    "osimertinib_tpsa_score", #osimertinib objective 1
    "osimertinib_logp_score", #osimertinib objective 2
    "osimertinib_similarity_v1_score", #osimertinib objective 3
    "osimertinib_similarity_v2_score", #osimertinib objective 4
    ...
    "ranolazine_mpo", #change here for separating ranolazine MPO
    "ranolazine_tpsa_score", #ranolazine objective 1
    "ranolazine_logp_score", #ranolazine objective 2
    "ranolazine_similarity_value", #ranolazine objective 3
    "ranolazine_fluorine_value", #ranolazine objective 4
    "perindopril_mpo", #change here for separating perindopril MPO
    "perindopril_similarity_value", #perindopril objective 1
    "perindopril_aromatic_rings", #perindopril objective 2
    "amlodipine_mpo", #change here for separating amlodipine MPO
    "amlodipine_similarity_value", #amlodipine objective 1 
    "amlodipine_num_rings_value", #amlodipine objective 2
    "sitagliptin_mpo",
    "zaleplon_mpo",
